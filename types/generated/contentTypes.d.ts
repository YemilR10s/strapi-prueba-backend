...
export interface ApiReservaReserva extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    nombrePersona: Schema.Attribute.String & Schema.Attribute.Required;
    correoElectronico: Schema.Attribute.Email & Schema.Attribute.Required;
    numeroTelefono: Schema.Attribute.BigInteger & Schema.Attribute.Required;
    fechaAndTime: Schema.Attribute.DateTime & Schema.Attribute.Required;
    ubicacion: Schema.Attribute.Enumeration<['Aranjuez', 'Bello', 'Envigado']> &
      Schema.Attribute.Required;
    personas: Schema.Attribute.Integer;
    confirmado: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    apellidoPersona: Schema.Attribute.String & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
